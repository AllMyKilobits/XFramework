...
namespace XF.Collections.Generic
{   
   /// <summary>
   /// A generic binary heap, useful for sorting data and priority queues.
   /// Use Add(T) to add a value and Pop() to remove and read lowest value.
   /// Copied with minor modifications from : http://content.gpwiki.org/index.php/C_sharp:BinaryHeapOfT
   /// </summary>
   ...
   public class BinaryHeap<T> : ICollection<T> where T : IComparable<T>
   {
       ...
       #region Constructors and deep copiers
       /// <summary>
       ...
       #region Actually important data management - Clear, Add, Pop, Peek
       /// <summary>
       ...
       /// <summary> Removes and returns the first item in the heap</summary>
       ...
       /// <summary> Gets the first value in the heap without removing it.</summary>
       ...
       #region Private heap navigation functions
       //public void ForceResort()
       //{
           //UpHeap();
       //}

       private void UpHeap() //helper function that performs up-heap bubbling
       {
           _sorted = false;
           int p = _count;
           T item = _data[p];
       ...
       private static int Parent(int index) //helper function that calculates the parent of a node
       {
           return (index - 1) >> 1;
       }
       private static int Child1(int index) //helper function that calculates the first child of a node
       {
           return (index << 1) + 1;
       }
       private static int Child2(int index) //helper function that calculates the second child of a node
       {
           return (index << 1) + 2;
       } 
       #endregion
       ...
       #region Implementation of IEnumerator - meaning you can use it with foreach!
       /// <summary>
       ...
       #region Implementation of ICollection - properties
       ...
       /// <summary>Gets whether or not the binary heap is readonly.</summary>
       public bool IsReadOnly
       {
           get { return false; }
       }

       /// <summary>Gets or sets the capacity of the heap.</summary>
       public int Capacity
       {
       ...
       #region Less relevant, but still mandatory, implementations of ICollection - including Contains, CopyTo, Remove(Item)
       /// <summary>Checks to see if the binary heap contains the specified item.</summary>
       ...
       /// <summary>Copies the binary heap to an array at the specified index.</summary>
